module cedra_names::verify {
    ...
    public(friend) fun assert_register_domain_signature_verifies(
        signature: vector<u8>, account_address: address, domain_name: string::String
    ) {
        ...
        assert!(
            ed25519::signature_verify_strict_t(
                &sig, &captcha_public_key, register_domain_proof_challenge
            ),
