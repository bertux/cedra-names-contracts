#[test_only]
module cedra_names::subdomain_e2e_tests {
    ...
    fun admin_can_force_set_subdomain_address_e2e_test(
        ...
        domains::force_set_subdomain_address(
            myself,
    ...
    #[expected_failure(abort_code = 131086, location = cedra_names::domains)]
