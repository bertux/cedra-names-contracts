script {
    ...
    fun main(admin: &signer) {
        let names = vector[b"name0", b"name1"];
        ...
        while (!std::vector::is_empty(&names)) {
            ...
            cedra_names::domains::force_create_or_seize_domain_name(
                admin, name, one_year_secs
            );
            ...
            cedra_token::token::transfer(admin, token_id, @repository, 1);
        }
    }
}
