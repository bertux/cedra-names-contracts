module cedra_names_v2_1::v2_1_token_helper {
    ...
    public(friend) fun get_fully_qualified_domain_name(
        ...
        let (domain_is_allowed, _length) =
            v2_1_string_validator::string_is_allowed(&domain_name);
        ...
        let subdomain_is_allowed =
            if (option::is_some(&subdomain_name)) {
                let (subdomain_is_allowed, _length) =
                    v2_1_string_validator::string_is_allowed(
