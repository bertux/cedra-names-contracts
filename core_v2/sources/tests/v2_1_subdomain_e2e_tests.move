#[test_only]
module cedra_names_v2_1::v2_1_subdomain_e2e_tests {
    ...
    #[expected_failure(abort_code = 131083, location = cedra_names_v2_1::v2_1_domains)]
    fun test_register_subdomain_with_invalid_string(
        ...
        v2_1_test_helper::register_name(
            router_signer,
            user,
            option::some(v2_1_test_helper::invalid_subdomain_name()),
            v2_1_test_helper::domain_name(),
    ...
    fun test_auto_renew_subdomain_e2e(
        ...
        assert!(
            v2_1_domains::get_subdomain_renewal_policy(
                v2_1_test_helper::domain_name(), v2_1_test_helper::subdomain_name()
            ) == 0,
            2
        );
    ...
    #[expected_failure(abort_code = 65562, location = cedra_names_v2_1::v2_1_domains)]
    ...
    #[expected_failure(abort_code = 327686, location = cedra_names_v2_1::v2_1_domains)]
    ...
    #[expected_failure(abort_code = 196632, location = cedra_names_v2_1::v2_1_domains)]
    fun test_set_expiration_date_for_subdomain(
        ...
        let domain_expiration_time_sec =
            v2_1_domains::get_expiration(
                v2_1_test_helper::domain_name(), option::none()
            );
    ...
    #[expected_failure(abort_code = 65561, location = cedra_names_v2_1::v2_1_domains)]
    ...
    #[expected_failure(abort_code = 131096, location = cedra_names_v2_1::v2_1_domains)]
    fun test_admin_cant_force_create_subdomain_more_than_domain_time_e2e(
        ...
        v2_1_domains::force_create_or_seize_name(
            ...
            v2_1_test_helper::domain_name(),
            option::some(v2_1_test_helper::subdomain_name()),
            v2_1_test_helper::one_year_secs() + 1
        );
    }
    ...
    fun test_subdomain_reset(
        ...
        // The subdomain should be clear (expired, no target addr, no owner)
        {
            ...
            let owner_addr =
                v2_1_domains::get_name_owner_addr(
                    option::some(v2_1_test_helper::subdomain_name()),
                    v2_1_test_helper::domain_name()
                );
