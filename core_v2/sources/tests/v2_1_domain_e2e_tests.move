#[test_only]
module cedra_names_v2_1::v2_1_domain_e2e_tests {
    use cedra_framework::timestamp;
    use cedra_framework::object;
    use cedra_names_v2_1::v2_1_config;
    use cedra_names_v2_1::v2_1_domains;
    use cedra_names_v2_1::v2_1_test_helper;
    use cedra_names_v2_1::v2_1_test_utils;
    use std::option;
    use std::signer;
    use std::string;
    use std::vector;
    ...
    fun test_happy_path_e2e(
        ...
        let users =
            v2_1_test_helper::e2e_test_setup(
                cedra_names_v2_1,
                user,
                &cedra,
                rando,
        ...
        v2_1_test_helper::set_target_address(
            user,
            v2_1_test_helper::domain_name(),
            option::none(),
            user_addr
        ...
        v2_1_test_helper::clear_target_address(
            user, option::none(), v2_1_test_helper::domain_name()
        );
        ...
        v2_1_test_helper::set_target_address(
            ...
            v2_1_test_helper::domain_name(),
            option::none(),
            signer::address_of(rando)
        );
        v2_1_test_helper::clear_target_address(
            rando, option::none(), v2_1_test_helper::domain_name()
        );
    ...
    fun test_renew_domain_e2e(
        ...
        let expiration_time_sec =
            v2_1_domains::get_expiration(
                v2_1_test_helper::domain_name(), option::none()
            );

        // Set the time is early than max remaining time for renewal from expiration time
        timestamp::update_global_time_for_test_secs(
            expiration_time_sec - MAX_REMAINING_TIME_FOR_RENEWAL_SEC - 5
        );
        assert!(
            !v2_1_domains::is_domain_in_renewal_window(v2_1_test_helper::domain_name()),
            1
        );
        ...
        // Renew the domain
        v2_1_domains::renew_domain(
            user, v2_1_test_helper::domain_name(), SECONDS_PER_YEAR
        );
    ...
    fun test_names_are_registerable_after_expiry_and_past_grace_period(
        ...
        timestamp::update_global_time_for_test_secs(
            expiration_time_sec + v2_1_config::reregistration_grace_sec() + 5
        );
        ...
        assert!(
            option::is_none(&v2_1_domains::get_reverse_lookup(signer::address_of(user))),
            85
        );
    ...
    #[expected_failure(abort_code = 196611, location = cedra_names_v2_1::v2_1_domains)]
    ...
    #[expected_failure(abort_code = 327689, location = cedra_names_v2_1::v2_1_domains)]
    ...
    #[expected_failure(abort_code = 327682, location = cedra_names_v2_1::v2_1_domains)]
    ...
    fun test_get_target_address_for_domain(
        ...
        let target_address =
            v2_1_domains::get_target_address(
                v2_1_test_helper::domain_name(), option::none()
            );
        assert!(target_address == option::some(user_addr), 2);

        timestamp::update_global_time_for_test_secs(
            v2_1_test_helper::one_year_secs() + 5
        );
        let target_address =
            v2_1_domains::get_target_address(
                v2_1_test_helper::domain_name(), option::none()
    ...
    fun test_get_expiration_for_domain(
        ...
        assert!(expiration_sec == v2_1_test_helper::one_year_secs(), 1);
    }
    ...
    fun test_get_reverse_lookup_for_domain(
        ...
        cedra_names_v2_1::v2_1_domains::set_reverse_lookup(
            user, option::none(), v2_1_test_helper::domain_name()
        );
        let token_addr =
            v2_1_domains::get_token_addr(
                v2_1_test_helper::domain_name(), option::none()
            );
        assert!(
            v2_1_domains::get_reverse_lookup(user_addr) == option::some(token_addr), 1
        );

        timestamp::update_global_time_for_test_secs(
            v2_1_test_helper::one_year_secs() + 5
        );
        assert!(option::is_none(&v2_1_domains::get_reverse_lookup(user_addr)), 1);
    }
    ...
    fun test_admin_can_force_set_target_address_e2e(
        ...
        v2_1_domains::force_set_target_address(
            cedra_names_v2_1,
            v2_1_test_helper::domain_name(),
            option::none(),
            rando_addr
        ...
        v2_1_test_utils::print_actual_expected(
    ...
    fun test_admin_can_force_renew_domain_name(
        ...
        assert!(
            expiration_time_sec / SECONDS_PER_YEAR == 1,
        ...
        v2_1_domains::force_set_name_expiration(
            ...
            v2_1_test_helper::domain_name(),
            option::none(),
            timestamp::now_seconds() + 2 * v2_1_test_helper::one_year_secs()
        );
        ...
        assert!(
            expiration_time_sec / SECONDS_PER_YEAR == 2,
            expiration_time_sec / SECONDS_PER_YEAR
        );
    }
    ...
    fun test_admin_can_force_seize_domain_name(
        ...
        v2_1_domains::force_create_or_seize_name(
            cedra_names_v2_1,
            v2_1_test_helper::domain_name(),
            option::none(),
            v2_1_test_helper::two_hundred_year_secs()
        );
        let is_owner =
            v2_1_domains::is_token_owner(
                signer::address_of(cedra_names_v2_1),
                v2_1_test_helper::domain_name(),
                option::none()
            );
        let is_expired =
        ...
        assert!(
            expiration_time_sec / SECONDS_PER_YEAR == 200,
            expiration_time_sec / SECONDS_PER_YEAR
        );
    ...
    fun test_admin_can_force_create_domain_name(
        ...
        v2_1_domains::force_clear_registration(
            cedra_names_v2_1, v2_1_test_helper::domain_name(), option::none()
        );
        assert!(
            !v2_1_domains::is_name_registered(
                v2_1_test_helper::domain_name(), option::none()
    ...
    fun test_owner_of_expired_name_is_not_owner(
        ...
        let is_owner =
            v2_1_domains::is_token_owner(
                user_addr, v2_1_test_helper::domain_name(), option::none()
            );
        let is_expired =
            v2_1_domains::is_name_expired(
                v2_1_test_helper::domain_name(), option::none()
    ...
    fun test_transfer(
        ...
        // rando is owner
        {
            let is_owner =
                v2_1_domains::is_token_owner(
                    rando_addr, v2_1_test_helper::domain_name(), option::none()
                );
            let is_expired =
                v2_1_domains::is_name_expired(
                    v2_1_test_helper::domain_name(), option::none()
    ...
    #[expected_failure(abort_code = 393221, location = cedra_names_v2_1::v2_1_domains)]
    fun test_cannot_set_unregistered_name_as_primary_name(
        ...
        cedra_names_v2_1::v2_1_domains::set_reverse_lookup(
            user, option::none(), string::utf8(b"notexist")
        );
    }
    ...
    fun test_register_during_reregistration_grace(
        ...
        v2_1_config::set_reregistration_grace_sec(cedra_names_v2_1, 30
            * SECONDS_PER_DAY);
        ...
        timestamp::update_global_time_for_test_secs(
            expiration_time_sec + v2_1_config::reregistration_grace_sec()
        );
    ...
    fun test_register_after_reregistration_grace(
        ...
        timestamp::update_global_time_for_test_secs(
            expiration_time_sec + v2_1_config::reregistration_grace_sec() + 1
        );
